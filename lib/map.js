...
var Map = (function (_React$Component) {
  function Map(props) {
    ...
    this.map = new ol.Map({
      interactions: [new interaction.DragPan(this.onDrag.bind(this)), new interaction.MouseWheelZoom(this.onZoom.bind(this)), new interaction.Draw(this.onDrawEnd.bind(this))]
    });
  }
  ...
  _createClass(Map, {
    ...
    onZoom: {
      value: function onZoom(newResolution) {
        this.props.actions.onNavigation({
    ...
    onDrawEnd: {
      value: function onDrawEnd(newFeature) {
